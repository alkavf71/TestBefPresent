...
# ========================================================================
# 🔥 FAULT PROPAGATION MAP DISPLAY (IMPROVED UI)
# ========================================================================
st.divider()
...
# CSS Styles for Better Alignment
st.markdown("""
<style>
    .prop-card {
...
for idx, prop in enumerate(propagation_map, 1):
    ...
    actions_html = ""
    for action in prop["repair_actions"]:
        # Clean action text if it already has checkmark to avoid double
    ...
    <div class="prop-card" style="border-left-color: {priority_color};">
        ...
        <div style="font-weight:600; color:#555; margin-bottom:5px;">🔗 Fault Chain:</div>
        <div class="fault-chain-container">
            {chain_html}
        </div>
        
        <div style="font-weight:600; color:#555; margin-bottom:5px; margin-top:15px;">🔧 Repair Actions:</div>
